...
window.checkEmailAuthConflictMessages = {
  en: {
    ...
    button: "Log In",
    message:
      "It looks like the email you entered is different from the one that was previously registered. Please log in again by clicking the button below.",
  },
  es: {
    title: "Email no registrado ",
    button: "Iniciar sesión",
    message:
      "Parece que el email que has ingresado es diferente del que se registró anteriormente. Por favor, inicia sesión de nuevo haciendo clic en el botón a continuación.",
  },
  "pt-BR": {
    title: "Conflito de email",
    button: "Entrar",
    message:
      "Parece que o email que você inseriu é diferente do que foi registrado anteriormente. Faça login novamente clicando no botão abaixo.",
  },
  ro: {
  ...
  bg: {
    ...
    button: "Влизане",
    message:
      "Изглежда, че въведеният от вас имейл е различен от този, който е бил регистриран преди това. Моля, влезте отново, като щракнете върху бутона по-долу.",
  },
  de: {
    title: "E-Mail-Konflikt",
    button: "Einloggen",
    message:
      "Es sieht so aus, als ob die eingegebene E-Mail sich von der unterscheidet, die zuvor registriert wurde. Bitte melden Sie sich erneut an, indem Sie auf den Button unten klicken.",
  },
  fr: {
    title: "Conflit d'e-mail",
    button: "Se connecter",
    message:
      "Il semble que l'e-mail que vous avez saisi soit différent de celui qui a été enregistré précédemment. Veuillez vous reconnecter en cliquant sur le bouton ci-dessous.",
  },
  it: {
    title: "Conflitto di email",
    button: "Accedi",
    message:
      "Sembra che l'email inserita sia diversa da quella registrata in precedenza. Accedi di nuovo cliccando sul pulsante in basso.",
  },
  ja: {
    title: "メールの不一致",
    button: "ログイン",
    message:
      "入力したメールアドレスが以前に登録したものと異なるようです。下のボタンをクリックし、もう一度ログインしてください。",
  },
  ko: {
    title: "이메일 충돌",
    button: "로그인",
    message:
      "입력한 이메일이 이전에 등록한 이메일과 다른 것 같습니다. 아래 버튼을 클릭하여 다시 로그인하세요.",
  },
  nl: {
    title: "E-mailconflict",
    button: "Inloggen",
    message:
      "Het lijkt erop dat het e-mailadres dat u hebt ingevoerd anders is dan het e-mailadres dat u eerder hebt geregistreerd. Log opnieuw in door op onderstaande knop te klikken.",
  },
  th: {
    title: "อีเมลไม่ตรงกัน",
    button: "ล็อกอิน",
    message:
      "ดูเหมือนว่าอีเมลที่คุณให้ต่างจากที่ลงทะเบียนไว้ โปรดล็อกอินอีกครั้งโดยคลิกปุ่มที่ด้านล่าง",
  },
  ca: {
    title: "Conflicte amb l'adreça electrònica",
    button: "Inicia la sessió",
    message:
      "Sembla que l'adreça electrònica que heu introduït és diferent de la que es va registrar anteriorment. Feu clic al botó de sota per tornar a iniciar la sessió.",
  },
  cs: {
    title: "Konflikt e-mailů",
    button: "Přihlásit se",
    message:
      "Vypadá to, že zadaný e-mail se liší od toho, který jste zaregistrovali dříve. Klikněte na tlačítko níže a přihlaste se znovu.",
  },
  da: {
    title: "E-mailkonflikt",
    button: "Log ind",
    message:
      "Det ser ud til, at den e-mail, du har indtastet, er anderledes end den, der tidligere blev registreret. Log venligst ind igen ved at klikke på knappen nedenfor.",
  },
  fi: {
    title: "Sähköpostiristiriita",
    button: "Kirjaudu",
    message:
      "Näyttää siltä, että syöttämäsi sähköpostiosoite on eri kuin aiemmin rekisteröity sähköpostiosoite. Kirjaudu uudelleen napsauttamalla alla olevaa painiketta.",
  },
  id: {
    title: "Konflik Email",
    button: "Masuk",
    message:
      "Tampaknya alamat email yang Anda masukkan berbeda dari yang sudah terdaftar sebelumnya. Silakan masuk kembali dengan mengklik tombol di bawah ini.",
  },
  no: {
    title: "E-postkonflikt",
    button: "Logg inn",
    message:
      "Det ser ut som om e-postadressen du skrev inn, er annerledes enn den som tidligere var registrert. Vennligst logg inn igjen ved å klikke på knappen nedenfor.",
  },
  pl: {
    title: "Konflikt e-mailowy",
    button: "Zaloguj się",
    message:
      "Wygląda na to, że wprowadzony e-mail jest inny niż poprzednio zarejestrowany. Zaloguj się ponownie, klikając poniższy przycisk.",
  },
  ru: {
    title: "Конфликт электронной почты",
    button: "Вход",
    message:
      "Похоже, введенная вами электронная почта отличается от зарегистрированной ранее. Повторите попытку входа, нажав кнопку ниже.",
  },
  sk: {
    title: "Konflikt e-mailov",
    button: "Prihlásenie",
    message:
      "Zdá sa, že e-mail, ktorý ste zadali, sa líši od e-mailu, ktorý ste predtým zaregistrovali. Prihláste sa znova kliknutím na tlačidlo nižšie.",
  },
  sl: {
    title: "Email konflikt",
    button: "Prijava",
    message:
      "Zdi se, da se vneseni e-poštni naslov razlikuje od tistega, ki je bil prej registriran. Prosimo, prijavite se ponovno s klikom na spodnji gumb.",
  },
  sv: {
    title: "Emailkonflikt",
    button: "Logga in",
    message:
      "Det verkar som att e-postadressen du angav skiljer sig från den som tidigare registrerades. Vänligen logga in igen genom att klicka på knappen nedan.",
  },
  uk: {
    title: "Конфлікт електронної пошти",
    button: "Вхід",
    message:
      "Схоже, електронна пошта, яку ви ввели, відрізняється від зареєстрованої раніше. Повторіть спробу входу, натиснувши кнопку нижче.",
  },
};
...
class checkEmailAuthConflict {
  ...
  changeUser() {
    ...
    $.ajax(
      `${this.getRootPath()}/checkout/changeToAnonymousUser/${
  ...
  validate() {
    ...
    try {
      if (
        ...
        fetch(`${this.getRootPath()}/api/vtexid/pub/authenticated/user`, {
          credentials: "include",
        })
...
/* source: <vtex.checkout-ui-custom@0.18.9> */
(() => {
  var e = {
      928: (e, o, a) => {
      ...
      117: (e, o, a) => {
        const { _locale: t } = a(146),
          {
            _countries: n,
            _countriesrules: r,
            _cities: s,
            _addressPlaceholder: d,
          } = a(540),
          { getShipStateValue: i } = a(255);
        (window.callbackMap = () => {
          ...
          (e.exports = class {
            ...
            setForm(
              ...
              $(
                ...
                "number" in C.addressrules &&
                  C.addressrules.number &&
                  C.addressrules.number.required
                  ? o
                  : a || o
              ),
                $(
                ...
                $(
                  ".vcustom--vtex-omnishipping-1-x-address #v-custom-ship-country"
                ).attr("data-country", e),
            ...
            updateGoogleForm(e = "usa") {
              ...
              $("input#v-custom-ship-street").attr(
                "placeholder",
                d[e.toUpperCase()] ? d[e.toUpperCase()] : ""
              ),
            ...
            googleForm() {
              ...
              (e.gPlacesAutocomplete =
                new window.google.maps.places.Autocomplete(o)),
                e.gPlacesAutocomplete.addListener("place_changed", function () {
                  ...
                  "number" in e.addressrules &&
                    ...
                    e.addressrules.number.required &&
                    $(
                  ...
                  const i =
                    ...
                    h = [o.geometry.location.lng(), o.geometry.location.lat()],
                    C = $("<div></div>");
                  C.html(o.adr_address);
                  let l = $(".street-address", C).text(),
                    u =
                      e.returnAddressFRules(
                        o.address_components,
                        e.addressrules.city
            ...
            receiverNameF() {
              const e = this;
              return e.orderForm.clientProfileData &&
                e.orderForm.clientProfileData.firstName &&
                e.orderForm.clientProfileData.lastName &&
            ...
            geti18n() {
              const { locale: e } = this.orderForm.clientPreferencesData,
                o = window.vtex.i18n[e] || window.vtex.i18n[e.split("-")[0]];
              return o || window.vtex.i18n.en, o;
            }
            sendAddress(e, o, a, t, n, r, s, d, i, m, h) {
              const C = this;
              if (~h.indexOf(",")) {
                const [o, n] = h.split(",");
                (h = [parseFloat(o), parseFloat(n)]),
                  "ARG" === e &&
                    "CABA" === r.toUpperCase() &&
                    (r = "Ciudad Autónoma de Buenos Aires"),
                  "MLT" === e && (t = null),
                  ("USA" !== e && "MLT" !== e && "CAN" !== e) || (a = null);
              } else h = [];
              ...
              window.vtexjs.checkout
                ...
                .done(function () {
                  $(window).trigger("VCUSTOM__ADDRESSFORM__CLEARED"),
                    $("button.vtex-front-messages-close-all.close").trigger(
                      "click"
                    ),
                    ...
                    window.vtexjs.checkout
                      ...
                      .done(function (m) {
                        m.error ||
                        !m.shippingData.address ||
                        m.items.filter(
                          (e) => "cannotBeDelivered" == e.availability
                        ).length == m.items.length
                          ? ($(
                              ".vtex-omnishipping-1-x-warning, .step.shipping-data .box-step"
                            ).show(),
                            $("body")
                              .addClass(C.BodyFormClasses.join(" "))
                              .removeClass(
                            ...
                            m.error &&
                              ...
                              alert(
                                `Something went wrong: ${
                                  m.error ? m.error.message : "null address"
                                }`
                              ),
                            m.items.filter(
                              (e) => "cannotBeDelivered" == e.availability
                              ...
                              C.messageTrigger(
                                C.geti18n().cart.unavailableForDelivery
                              ))
                          : (C.updateAddress(
                              e,
                              n,
                            ...
                            $("body")
                              .removeClass(C.BodyFormClasses.join(" "))
                      ...
                      .fail(function (e) {
                        (C.orderForm = window.vtexjs.checkout.orderForm),
                          ...
                          console.error(
                            `Something went wrong: Custom Address Form (sendAddress) --\x3e ${e}`
                          );
                      });
                })
                .fail(function (e) {
            ...
            getRegions(e) {
              return s
                ...
                .regions.map(
                  (e) =>
                    `<option value="${e.shortCode},${e.name}">${e.name}</option>`
                );
            }
            getCountries() {
              const e = this;
              return (
                (e.deliveryCountries != ["BRA"] &&
                  "BRA" != e.deliveryCountries) ||
                  (e.deliveryCountries =
            ...
            updateFormFieldByCountry(e) {
              const o = $(
                  ".vcustom--vtex-omnishipping-1-x-address p.ship-number"
                ),
                a = $(".vcustom--vtex-omnishipping-1-x-address p.ship-state");
              "number" in e && e.number && e.number.required
            ...
            form(e) {
              const o = this,
                ...
                s = `\n      <div class="vcustom--vtex-omnishipping-1-x-address step">\n        <div>\n        <form>\n            <p class="input v-custom-ship-street required text"><label id="address1-label" for="v-custom-ship-street">${
                  ...
                  a.address && null !== a.address.street && !r
                    ? a.address.street
                    : ""
                  ...
                  "number" in o.addressrules &&
                  o.addressrules.number &&
                  ...
                  a.address && null !== a.address.number && !r
                    ? a.address.number
                    : ""
                  ...
                  a.address && null !== a.address.city && !r
                    ? a.address.city
                    : ""
                }"><span class="help error" style="">${
                  o.locale.requiredField
              ...
              a.address &&
                ...
                0 == $(".vcustom--vtex-omnishipping-1-x-address.step").length &&
                  "pickup-in-point" !==
                    a.logisticsInfo[0].selectedDeliveryChannel &&
            ...
            scrollToAddress() {
              const e = document.documentElement,
                o = (window.pageYOffset || e.scrollTop) - (e.clientTop || 0),
                a = $("#shipping-data").offset().top;
              o > a && window.scrollTo(0, a);
            }
            submitAddressForm() {
              const e = this;
              if ((e.validateAllFields(), !e.validate)) return;
              const o = $(
                  ".vcustom--vtex-omnishipping-1-x-address #v-custom-ship-street"
                ),
                a = $(
                ...
                i = $(
                  ".vcustom--vtex-omnishipping-1-x-address #ship-city"
                ).val(),
                [m, h] = $(
              ...
              $("body").on(
                ...
                function () {
                  if (
                    ...
                    let a = e.orderForm.shippingData.availableAddresses.find(
                      (o) =>
                        o.addressId ==
                        e.orderForm.shippingData.address.addressId
                    );
                    if (
                      (a ||
                        (a =
                          o < 0
                            ? a.selectedAddresses[0]
                            : a.availableAddresses[o]),
                      a && a.city && a.city.indexOf("*") < 0)
                    )
                      try {
                        $("body").addClass(e.BodyFormClasses.join(" ")),
                          (a.isDisposable ||
                            ...
                            setTimeout(() => {
                              let o = e.deliveryCountries.filter(
                                (e) => e == a.country
                              );
                              (o = o.length ? o[0] : e.deliveryCountries[0]),
                                (a.street = a.street || ""),
                                e.updateAddress(
                                  o,
                                  a.postalCode,
                ...
                $("body").on(
                  ...
                  function () {
                    e.address.addressId = e.orderForm.shippingData
                      .availableAddresses[$(this).index()]
                      ? e.orderForm.shippingData.availableAddresses[
                          $(this).index()
                        ].addressId
                      : "";
                  }
                ...
                $("body").on(
                  ...
                  function (o) {
                    ...
                    try {
                      ...
                      console.error(
                        `updateFormByCountry ${this.value} error:`,
                        e
                      );
                    }
                  }
              ...
              e &&
                ...
                ((null !== e.shippingData.address &&
                  ...
                  "shipping-option-delivery" !==
                    $(".vtex-omnishipping-1-x-deliveryOptionActive").attr(
                      "id"
                    ) ||
                  $("body").addClass(this.BodyFormClasses[0]));
            }
            getCountryRule(e) {
              const o = this;
            ...
            events() {
              ...
              e.loadingAddress(),
                $(window).on("orderFormUpdated.vtex", function (o, a) {
                  (e.orderForm = a), e.checkFirstLogin(a);
                });
            }
            init(e) {
              const o = this;
              try {
                window.google || o.loadScript();
              } catch (e) {
                console.warn(
              ...
              if (
                ...
                const a =
                  (o.orderForm.shippingData &&
                    o.orderForm.shippingData.address &&
                    o.orderForm.shippingData.address.country) ||
                  o.orderForm.storePreferencesData.countryCode;
                $("body").addClass(`${this.classOn}`),
                  (o.orderForm = e),
                  o.getCountryRule(a).then((a) => {
                    if (
                      ((o.addressrules = a),
                      o.bind(),
                      (o.deliveryCountries =
                        window.checkout.deliveryCountries()),
                      (o.mainCountry = window.checkout.countryCode()),
                      (o.lang = o.orderForm.clientPreferencesData.locale),
                      (o.locale =
                        t[o.orderForm.storePreferencesData.countryCode] ||
                        t.GBR),
      ...
      146: (e) => {
        e.exports._locale = {
          ...
          ITA: {
            couponInactive:
              "Nessuno sconto disponibile. Controlla le condizioni.",
            editLabel: "Modifica",
            paypalImg: "",
            paypalPhone: "",
          ...
          SWE: {
            couponInactive:
              "Inga rabatter tillgängliga, kontrollera villkoren.",
            editLabel: "Redigera",
            paypalImg: "",
            paypalPhone: "",
          ...
          RUS: {
            ...
            address1Placeholder:
              "Адрес проживания/улица или адрес почтового ящика",
          ...
          CHE: {
            couponInactive:
              "Keine Rabatte verfügbar. Prüfen Sie die Bedingungen.",
          ...
          CZE: {
            couponInactive:
              "Nie sú dostupné žiadne zľavy. Pozrite si podmienky.",
            editLabel: "Upraviť",
            paypalImg: "",
            paypalPhone: "",
      ...
      255: (e) => {
        (e.exports.debounce = (e, o) => {
          ...
          (e.exports.getShipStateValue = (e) =>
            $(
              `.vcustom--vtex-omnishipping-1-x-address #ship-state option[value^='${e}']`
            ).val() ||
            $(
              `.vcustom--vtex-omnishipping-1-x-address #ship-state option[value$='${e}']`
            ).val()),
          (e.exports.parseDateBd = (e) => {
            const o = e.match(/(\d+)/g);
        ...
        e.exports = class {
          constructor({
            ...
            (this.type = e),
              ...
              (this._holidays = null),
              (this.countriesRules = i),
              (this.countries = m),
              (this.cities = h),
              (this.addressPlaceholder = C);
          }
          general() {
          ...
          buildVertical() {
            $("body").addClass("body-cart-vertical"),
              $(".cart-template .cart-links-bottom:eq(0)").length &&
                (this.checkoutButton = $(
                  ".cart-template .cart-links-bottom:eq(0)"
                )),
              this.checkoutButton &&
                this.checkoutButton.appendTo(
          ...
          showCustomMsgCoupon(e) {
            ...
            let t = null;
            if (
              (e.ratesAndBenefitsData &&
                e.ratesAndBenefitsData.rateAndBenefitsIdentifiers.length &&
                (t = e.ratesAndBenefitsData.rateAndBenefitsIdentifiers.find(
                  (e) => e.name === o
                )),
              !o || a > 0 || t)
            )
          ...
          buildMiniCart(e) {
            if (0 === e.items.filter((e) => null !== e.parentItemIndex).length)
              return !1;
            const o = e.items;
            $(".mini-cart .cart-items > li").length === o.length &&
          ...
          setParentIndex(e) {
            const o = e.items.filter((e) => !e.isGift);
            $.each(o, function (e) {
          ...
          handleBreakpointChange() {
            window.innerWidth <= 767 &&
              $("body").on("click", "#edit-address-button", () => {
                setTimeout(() => {
                  const e =
                    document.getElementById("shipping-data").offsetTop - 200;
                  window.scrollTo({
                    top: e,
                    behavior: "smooth",
                  });
          ...
          enchanceSummary(e, o) {
            ...
            if (
              a.orderForm &&
              $(".mini-cart .cart-items > li").length ===
                a.orderForm.items.length &&
              ($(`.mini-cart .cart-items > li:eq(${e})`)
              ...
              for (const t in o) {
                ...
                const n = o[t];
                $(
                  `.mini-cart .cart-items > li:eq(${e}) > .v-custom-bundles`
                ).append(
                  `\n            <div class="hproduct item v-custom-indexed-item ${
                    n.sellingPrice ? "" : "free-item"
                  }" data-sku="${n.id}">\n              <a href="${
                    n.detailUrl
                    ...
                    n.sellingPrice
                      ? `${a.orderForm.storePreferencesData.currencySymbol} ${r(
                          a.orderForm.clientPreferencesData.locale,
                          a.orderForm.storePreferencesData.currencyCode,
                          n.sellingPrice
                        ).toFixed(2)}`
                      : "Free"
                  } </strong>\n              </div>\n            </div>\n          `
                ),
                  $(`.mini-cart .cart-items > li[data-sku='${n.id}']`).addClass(
          ...
          indexedInItems(e) {
            ...
            try {
              if (
                0 === e.items.filter((e) => null !== e.parentItemIndex).length
              )
                return o.removeMCLoader(), !1;
              const a = e.items.filter((e) => !e.isGift);
              if (a.length) {
                const e = a.reduce((e, o) => {
                  if (null !== o.parentItemIndex) {
                ...
                for (const a in e) {
                  ...
                  if (
                    ...
                    for (const e in t) {
                      ...
                      const o = t[e];
                      $(
                        `.table.cart-items tbody > tr.product-item[data-sku='${o.id}'][data-parentitemindex='${o.parentItemIndex}'], .table.cart-items tbody > tr.product-item[data-sku='${o.id}'][data-parentitemindex='${o.parentItemIndex}'] + .item-unavailable`
                      )
          ...
          addBusinessDays(e, o, a = window.i18n.options.lng) {
            const t = this,
              n = o.replace(/[0-9]/g, "");
            try {
              let o = new Date();
              ...
              (t._holidays &&
                ...
                !t._holidays ||
                (s = t.holidaysBetweenDates(
                  new Date(),
                  o,
                  t._holidays.map((e) => e.startDate.split("T")[0])
                )),
                t._holidays &&
                  t._holidays.name &&
                  "Error" === t._holidays.name &&
              ...
              return (
                ...
                o.getDate() - new Date().getDate() == 1
                  ? t.lang.tomorrowLabel || "Tomorrow"
                  : ((i = i.toLocaleDateString(a, m)), i)
              );
            } catch (e) {
          ...
          changeShippingTimeInfo() {
            ...
            const o = [
              ...
              [a] = window.vtexjs.checkout.orderForm.shippingData.logisticsInfo,
              t = a.slas,
              { selectedSla: n } = a,
              r =
                !!t.find((e) => e.name === n) &&
            ...
            try {
              $(
                ...
                if (
                  ($(this).hasClass("srp-delivery-current-many")
                    ? r && (t = parseInt(r.match(/\d+/), 10))
                    : "" !== a &&
                      a.match(/(day)|(dia)|(día)|(tag)/gm) &&
                      (t = parseInt(a.match(/\d+/), 10)),
                  t)
                ) {
                  ...
                  $(this)
                    ...
                    $(this)
                      .find(o.join(", "))
                      .html(`${a} <strong>${e.addBusinessDays(t, r)}</strong>`)
              ...
              if (($(".js-shippingPreviewPackges").remove(), a.length)) {
                ...
                $.each(o, function (a) {
                  const n = o[a];
                  if ("" !== n && n.match(/(day)|(dia)|(día)|(tag)/gm)) {
                    ...
                    if (o) {
                      ...
                      n
                        ...
                        t.push(
                          `${a} <strong>${e.addBusinessDays(o, r)}</strong>`
                        );
                    }
                  }
                }),
          ...
          fetchHolidays() {
            ...
            e._holidays ||
              fetch(`${o}/_v/holidays`, {
                ...
                .catch(function (e) {
                  console.log("holidays error", e);
                });
          }
          changeShippingTimeInfoInit() {
            const e = this;
            e.lang &&
              e.deliveryDateFormat &&
              (e.fetchHolidays(), e.changeShippingTimeInfo());
          }
          enchancementTotalPrice(e) {
            const o = this;
            if (o.quantityPriceCart)
              try {
                $.each(e.items, function (a) {
                  const t = this,
                    n = $(`.table.cart-items tbody tr.product-item:eq(${a})`);
                  if (
                    1 === t.quantity ||
                    0 === n.find("td.product-price").find(".best-price").length
                  )
                    return;
                  const r = n.find(".total-selling-price:eq(0)").text(),
                    s = `\n          <div class="v-custom-quantity-price vqc-ldelem">\n            <span class="v-custom-quantity-price__list">\n              ${
                      t.listPrice > t.sellingPrice
                        ? `<span class="v-custom-quantity-price__list--list">${
                            e.storePreferencesData.currencySymbol
                          } ${(t.listPrice / 100).toFixed(2)}</span>`
                        : ""
                    }\n            </span>\n          </div>\n        `;
                  n.find("td.product-price").find(".vqc-ldelem").remove(),
                    n
                      ...
                      .prepend(s)
                      .append(
                        `<div class="v-custom-quantity-price vqc-ldelem"><span class="v-custom-quantity-price__best">${r}</span></div>`
                      ),
                    n
                      .find("td.product-price")
                      .find("> .best-price")
          ...
          updateStep() {
            const e = "v-custom-step-",
              o = ["cart", "email", "profile", "shipping", "payment"];
            if (
              ($("body").removeClass(o.map((o) => e + o).join(" ")),
              window.location.hash)
            ) {
              const [, a] = window.location.hash.split("/"),
                t = o.filter((e) => ~a.indexOf(e));
              t.length && $("body").addClass(e + t[0]);
            }
          }
          updateLang(e) {
            ...
            if (
              ...
              a.paypalPhone &&
                $(".payment-paypal-help-number").text(a.paypalPhone),
              a.paypalImg
          ...
          paymentBuilder(e) {
            ...
            if (
              e &&
              0 === $(".payment-group-item-cards").length &&
              e.paymentData
            ) {
              ...
              $.each(a, function (n) {
                (t = '<span class="payment-group-item-cards">'),
                  $.each(
                    e.paymentData.paymentSystems.filter(
                      (e) => e.groupName === a[n]
                    ),
                    function () {
          ...
          customAddressFormLoader() {
            ...
            e.customAddressForm &&
              ((e.customAddressForm = new l({})), e.customAddressForm.events());
          }
          goToShippingStep() {
            window.location.hash = "#/shipping";
          }
          appendMessageEmptyStreet(e) {
            e &&
            e.shippingData &&
          ...
          URLHasIncludePayment(e) {
            ...
            try {
              e &&
                e.shippingData &&
                e.shippingData.address &&
                e.shippingData.address.street &&
                (a = e.shippingData.address.street),
                "#/payment" === window.location.hash &&
                  ...
                  !a.trim() &&
                  o.customAddressForm &&
                  (o.goToShippingStep(), o.appendMessageEmptyStreet(e));
            } catch (e) {
              console.error("URLHasIncludePayment error:", e);
            }
          }
          customAddressFormInit(e) {
            const o = this,
              a = e || window.vtexjs.checkout.orderForm;
            if (o.customAddressForm) {
              a.canEditData
          ...
          bind() {
            ...
            $("body").on("click", "#v-custom-edit-login-data", function (o) {
              ...
              window.addEventListener("resize", e.handleBreakpointChange),
                ...
                $(window).on("hashchange", function () {
                  ...
                  e.updateStep(),
                    ...
                    e.orderForm &&
                      ...
                      e.customAddressFormInit(e.orderForm),
                      e.removeCILoader(),
                      e.URLHasIncludePayment(e.orderForm),
                      e.onDomMutation({
                        targetNode: o,
  ...
  function a(t) {
    ...
    return e[t](r, r.exports, a), r.exports;
  }
  (a.g = (function () {
...
var backToHome =
  '<button class="bt-keep-buying btn-outline" title="Botão: Continuar comprando"><i class="fas fa-arrow-left"></i> Continuar comprando</button>';
